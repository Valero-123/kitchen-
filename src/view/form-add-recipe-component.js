...
function createFormAddRecipeComponentTemplate() {
    ...
    <div class="search-section">
        ...
        <button class="clear-filters-btn" type="button" style="padding: 1rem 1.5rem; border: 2px solid var(--border); border-radius: 14px; background: var(--surface); color: var(--text-secondary); cursor: pointer; font-weight: 500;">Очистить фильтры</button>
    </div>
